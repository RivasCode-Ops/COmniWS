...
export function ViewAmbiente({
  ...
  const nodes: OperacionalNodeData[] = [
    {
      id: 'amb-scan',
      categoria: 'ambiente',
      nome: 'Atualizar inventário',
      subtitulo: modoFoco ? 'Pausado em FOCO' : 'winget list',
      acaoLabel: 'Escanear',
    ...
    ...ausentes.map((a) => ({
      ...
      nome: a.nome,
      subtitulo: 'Ferramenta ausente',
      acaoLabel: 'Sugerir install',
  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      <h2 className="text-lg font-semibold mb-4">Ambiente Windows</h2>
